        ...
        <div className="container flex h-16 items-center justify-between">
          <div className="flex items-center gap-2">
            <div className="relative">
              <div className="absolute -inset-1 bg-gradient-to-r from-[#876FFD] to-[#19074A] rounded-full blur-sm opacity-70 animate-pulse"></div>
              <div className="relative">
                <Image src="/logo.svg" alt="Xcel 360° Logo" width={40} height={40} className="h-10 w-10" />
              </div>
            </div>
            <span className="text-xl font-bold bg-gradient-to-r from-[#876FFD] to-[#19074A] text-transparent bg-clip-text">
              Xcel 360°
            </span>
          </div>
          <nav className="hidden md:flex items-center gap-6">
            <Link href="#" className="text-sm font-medium text-[#19074A] hover:text-[#876FFD] transition-colors">
              Home
            </Link>
            <Link href="#tests" className="text-sm font-medium text-[#19074A] hover:text-[#876FFD] transition-colors">
              Our Tests
            </Link>
            <Link
              href="#benefits"
            ...
            <Link href="#sample" className="text-sm font-medium text-[#19074A] hover:text-[#876FFD] transition-colors">
              Sample Report
            </Link>
            <Link href="#faq" className="text-sm font-medium text-[#19074A] hover:text-[#876FFD] transition-colors">
              FAQ
            </Link>
          </nav>
          ...
          <div className="grid gap-8 md:grid-cols-2 items-center">
            ...
            >
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/80 backdrop-blur-sm border border-[#876FFD]/20 shadow-sm">
                ...
                <span className="text-sm font-medium text-[#19074A]">Discover your superpower!</span>
              </div>
              ...
              <p className="text-lg text-gray-700 max-w-md">
                Take our <span className="font-bold text-[#876FFD]">super fun quiz</span> and unlock your hidden
                talents! It's like a video game, but for your future! 🚀
              </p>
              <motion.div
        ...
        <div className="container">
          <div className="text-center mb-16">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#876FFD]/10 mb-4">
              ...
              <span className="text-sm font-medium text-[#19074A]">Choose Your Adventure</span>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6 relative z-10">
              {[
                ...
                <motion.div
                  ...
                  whileHover={{ y: -5 }}
                >
                  <div className="bg-white/20 p-3 rounded-full w-fit mb-4">{test.icon}</div>
      ...
      <section id="benefits" className="py-20 relative overflow-hidden">
        ...
        <div className="container relative z-10">
          <div className="text-center mb-16">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#876FFD]/10 mb-4">
              <Sparkles className="h-4 w-4 text-[#876FFD]" />
              <span className="text-sm font-medium text-[#19074A]">Unlock Special Powers</span>
            </div>
            <h2 className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-[#876FFD] to-[#19074A] text-transparent bg-clip-text mb-4">
              Your Career Superpowers
            </h2>
            <p className="text-lg text-gray-700 max-w-2xl mx-auto">
              Discover amazing abilities you never knew you had with our magical career assessment!
            </p>
          </div>
      ...
      <section id="sample" className="py-20 bg-white">
        <div className="container">
          <div className="text-center mb-16">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#876FFD]/10 mb-4">
              <Sparkles className="h-4 w-4 text-[#876FFD]" />
              <span className="text-sm font-medium text-[#19074A]">Your Adventure Map</span>
            </div>
            <h2 className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-[#876FFD] to-[#19074A] text-transparent bg-clip-text mb-4">
              Your Magical Career Report
            </h2>
            <p className="text-lg text-gray-700 max-w-2xl mx-auto">
              Unlock the secrets of your future with our enchanted career report that reveals your true potential!
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-10 items-center">
            ...
            >
              <div className="bg-gradient-to-r from-[#876FFD]/20 to-[#19074A]/20 p-6 rounded-2xl">
                <h3 className="text-xl font-bold text-[#19074A] mb-3">Your Interest Constellation</h3>
              ...
              <div className="bg-gradient-to-r from-[#19074A]/20 to-[#876FFD]/20 p-6 rounded-2xl">
                <h3 className="text-xl font-bold text-[#19074A] mb-3">Your Motivation Crystals</h3>
                <p className="text-gray-700 mb-4">
                  See what energizes and drives you with our magical motivation crystals that power your career journey!
                </p>
                <ul className="space-y-3">
                  {[
                    { name: "Security & Stability", color: "#876FFD" },
                    { name: "Autonomy & Independence", color: "#7057e3" },
                    { name: "Technical/Functional Competence", color: "#19074A" },
                  ].map((crystal, index) => (
                    <motion.li
                      key={index}
            ...
            >
              <div className="bg-white rounded-2xl shadow-xl p-6 border border-[#876FFD]/30 relative z-10">
                <div className="flex items-center justify-between mb-6">
                  <div className="flex items-center gap-2">
                    <div className="relative">
                      <div className="absolute -inset-1 bg-gradient-to-r from-[#876FFD] to-[#19074A] rounded-full blur-sm opacity-70"></div>
                      <div className="relative">
                        <Image src="/logo.svg" alt="Xcel 360° Logo" width={30} height={30} />
                      </div>
                    </div>
                ...
                <div className="space-y-4">
                  <div className="bg-gradient-to-r from-[#876FFD]/5 to-[#19074A]/5 p-3 rounded-lg">
                    <h4 className="text-sm font-medium text-[#876FFD]">Adventurer Name</h4>
                    <p className="font-medium">Riya Gantayat</p>
                  </div>

                  <div className="bg-gradient-to-r from-[#876FFD]/5 to-[#19074A]/5 p-3 rounded-lg">
                    <h4 className="text-sm font-medium text-[#876FFD]">Level</h4>
                    <p className="font-medium">Bachelors & Above</p>
                  </div>

                  <div className="bg-gradient-to-r from-[#876FFD]/5 to-[#19074A]/5 p-3 rounded-lg">
                    <h4 className="text-sm font-medium text-[#876FFD]">Quest Completed</h4>
                    ...
                    <div className="space-y-3">
                      <div className="bg-gradient-to-r from-[#876FFD]/10 to-[#19074A]/10 p-3 rounded-lg">
                        <div className="flex items-center gap-2 mb-1">
                          ...
                          <h4 className="text-sm font-medium text-[#876FFD]">Primary Quests</h4>
                        </div>
                        <p className="font-medium">Visual Arts, Design, Media and Entertainment</p>
                      </div>

                      <div className="bg-gradient-to-r from-[#876FFD]/10 to-[#19074A]/10 p-3 rounded-lg">
                        <div className="flex items-center gap-2 mb-1">
                          <Star className="h-4 w-4 text-[#19074A]" />
                          <h4 className="text-sm font-medium text-[#19074A]">Side Quests</h4>
                        </div>
                        <p className="font-medium">Creative Technology, Writing and Communication</p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="mt-6 pt-6 border-t border-dashed border-[#876FFD]/30 text-center">
                  <p className="text-sm text-gray-500 mb-3">Unlock your full adventure map now!</p>
        ...
        <div className="container">
          <div className="text-center mb-16">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 backdrop-blur-sm mb-4">
              ...
              <span className="text-sm font-medium text-white">Hero Stories</span>
            </div>
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">What Our Young Adventurers Say</h2>
            <p className="text-lg text-white/80 max-w-2xl mx-auto">
              Hear from fellow students who have discovered their epic career paths!
            </p>
          </div>
        ...
        <div className="container">
          <div className="text-center mb-16">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#876FFD]/10 mb-4">
              ...
              <span className="text-sm font-medium text-[#19074A]">Quest Guide</span>
            </div>
            <h2 className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-[#876FFD] to-[#19074A] text-transparent bg-clip-text mb-4">
              Adventure FAQ
            </h2>
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            {[
              ...
              },
              {
                ...
                answer: "Level up every 1-2 years as your character develops new skills and interests on your journey!",
              },
            ].map((faq, index) => (
              <motion.div
                key={index}
        ...
        <div className="container relative z-10">
          ...
          >
            ...
            <p className="text-xl text-white/90 mb-8">
              Take the first step towards discovering your hidden talents and unlocking your dream future!
            </p>
        ...
        <div className="container">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <div className="flex items-center gap-2 mb-4">
                <div className="relative">
                  <div className="absolute -inset-1 bg-gradient-to-r from-[#876FFD] to-white rounded-full blur-sm opacity-70"></div>
                  <div className="relative">
                    <Image src="/logo-white.svg" alt="Xcel 360° Logo" width={40} height={40} className="h-10 w-10" />
                  </div>
                </div>
                <span className="text-xl font-bold">Xcel 360°</span>
              </div>
              <p className="text-white/70">
                Your magical guide to discovering awesome career adventures and unlocking your hidden superpowers!
              </p>
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <a href="#tests" className="text-white/70 hover:text-white transition-colors">
                    Our Tests
                  </a>
                </li>
                <li>
                ...
                <li>
                  <a href="#sample" className="text-white/70 hover:text-white transition-colors">
                    Sample Report
                  </a>
                </li>
                <li>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li className="flex items-center gap-2">
                  <svg className="h-5 w-5 text-[#876FFD]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path
                      strokeLinecap="round"
                ...
                <li className="flex items-center gap-2">
                  ...
                  <a href="tel:+919019033345" className="text-white/70 hover:text-white transition-colors">
                    +91 9019033345
                  </a>
                </li>
              </ul>
              <div className="mt-6">
                ...
                <div className="flex gap-2">
                  ...
                  />
                  <Button className="bg-[#876FFD] hover:bg-[#7057e3]">Join</Button>
                </div>
              </div>
            </div>
          </div>
          <div className="border-t border-white/10 mt-8 pt-8 text-center">
            <p className="text-white/50">
              © {new Date().getFullYear()} Xcel 360°. All rights reserved. Made with ❤️ for students.
            </p>
          </div>
        </div>
      </footer>
